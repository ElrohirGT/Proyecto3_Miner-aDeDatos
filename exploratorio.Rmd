...
g <- ggplot(agresion_principales, aes(x = VIC_GRUPET, y = porcentaje, fill = HEC_TIPAGRE)) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_viridis_d(option = "C") +
  labs(
    title = "Tipos de agresión por grupo étnico de la víctima",
    subtitle = "Distribución porcentual para los 5 grupos étnicos con más denuncias",
    x = "Grupo étnico de la víctima",
    y = "Porcentaje (%)",
...
- Identificar características demográficas de víctimas y agresores en los casos de violencia.
- Contextualizar los hallazgos considerando las limitaciones de los datos, incluyendo el posible "sesgo del superviviente" en las estadísticas.
- Categorizar los tipos de agresión más frecuentes y su prevalencia en los diferentes departamentos del país.
